...
const Cart = () => {
  ...
  const deleteCart = ( item ) => {
    dispatch( deleteFromCart( item ) ); // Dispatch action to remove item from cart
  ...
  const buyNow = () => {
    ...
    //---------------------razorpay code for payment-------------------//

    // ============================== storing order information in options ====================== //
    var options = {
      key: "rzp_test_L58fLzpOZwkQV5",
      key_secret: "VtbtOwlzAxkjnM3cxAVwkkJL",
